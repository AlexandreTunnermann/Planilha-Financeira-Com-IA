...
import { CheckCircle2, ShieldCheck, CreditCard, Zap, MessageCircleQuestion, Wallet, HelpCircle, ClipboardList, Receipt } from 'lucide-react'; // Icons for checkmarks, FAQ, and new icons for pain points
...
const LandingPage = () => {
  ...
  const darkGreenSectionBgColor = "#061A16"; // Novo tom de verde escuro

  const painPoints = [
    { text: "Parece que eu trabalho, trabalho e não vejo a cor do dinheiro.", icon: Wallet },
    { text: "Onde foi que eu gastei esses 200 reais que estavam aqui ontem?", icon: HelpCircle },
    { text: "A fatura do cartão é uma surpresa desesperadora todo mês.", icon: CreditCard },
    { text: "Eu desisti de anotar porque sempre esqueço de pedir a nota fiscal.", icon: ClipboardList },
    { text: "Sinto que estou em uma corrida de ratos, vivendo apenas para pagar boleto.", icon: Receipt }
  ];
  ...
  return (
    <div className="font-inter antialiased" style={{ backgroundColor: bgColor, color: '#FFFFFF' }}>
      ...
      {/* DOBRA 1 - HEADLINE */}
      <section className="flex items-center px-6 py-[75px] md:py-[100px]" style={{ background: bgGradient }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 max-w-4xl tracking-tighter">
              Planilha de Controle Financeiro <span style={{ color: primaryColor }}>Automatizado com IA</span>
            </h1>
      ...
      <section className="py-[75px] md:py-[100px] px-6" style={{ backgroundColor: safetyBgColor, color: bgColor }}>
      ...
      <section className="py-[75px] md:py-[100px] px-6" style={{ backgroundColor: bgColor }}>
      ...
      <section className="py-[75px] md:py-[100px] px-6" style={{ backgroundColor: bgGradient }}>
        <div className="max-w-4xl mx-auto text-center">
      ...
      {/* DOBRA 8 - ANCORAGEM */}
      <section className="py-[75px] md:py-[100px] px-6" style={{ backgroundColor: darkGreenSectionBgColor, color: '#FFFFFF' }}>
      ...
      {/* DOBRA 9 - PREÇO + BOTÃO */}
      <section id="purchase" className="py-[75px] md:py-[100px] px-6 flex justify-center" style={{ backgroundColor: darkGreenSectionBgColor, color: '#FFFFFF' }}>
        <div className="w-full max-w-lg rounded-3xl p-10 text-center shadow-[0_0_50px_rgba(204,255,0,0.1)]" style={{ backgroundColor: surfaceColor, border: `2px solid ${primaryColor}` }}>
