...
const LandingPage = () => {
  ...
  return (
    <div className="font-inter antialiased" style={{ backgroundColor: bgColor, color: '#FFFFFF' }}>
      ...
      <section className="py-12 md:py-8 px-6" style={{ backgroundColor: bgGradient }}>
        <div className="max-w-4xl mx-auto text-center">
      ...
      {/* DOBRA 8 - ANCORAGEM */}
      <section className="py-12 md:py-8 px-6" style={{ backgroundColor: darkGreenSectionBgColor, color: '#FFFFFF' }}>
      ...
      {/* DOBRA 9 - PREÇO + BOTÃO */}
      <section id="purchase" className="py-12 md:py-8 px-6 flex justify-center" style={{ backgroundColor: darkGreenSectionBgColor, color: '#FFFFFF' }}>
